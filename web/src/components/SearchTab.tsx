    ...
    <div className="pb-4">
      ...
      {searching ? (
        ...
        <>
          {tracks.length > 0 && (
            <>
              <h2 className="text-xs font-semibold text-[var(--text-muted)] uppercase tracking-wider px-4 md:px-6 mb-1">Tracks</h2>
              {tracks.map((track, i) => (
          ...
          {stations.length > 0 && (
            <>
              <h2 className="text-xs font-semibold text-[var(--text-muted)] uppercase tracking-wider px-4 md:px-6 mb-1 mt-4">Radio Stations</h2>
