  ...
  return (
    <div className="pb-4">
      ...
      <div className="px-4 pt-6 pb-8 text-center">
        <div className="inline-flex items-center gap-1.5 px-3 py-1 bg-[var(--accent)]/15 text-[var(--accent)] rounded-full text-xs font-semibold mb-4">
        ...
        <h1 className="text-3xl sm:text-4xl font-bold leading-tight mb-3" style={{ fontFamily: "'DM Serif Display', serif" }}>
          All the world's<br/><em className="text-[var(--accent)] italic">free music</em><br/>in one app
        </h1>
      ...
      {/* Stats */}
      <div className="mx-4 grid grid-cols-3 border border-[var(--border)] rounded-2xl overflow-hidden mb-8">
        <div className="bg-[var(--surface)] p-4 text-center border-r border-[var(--border)]">
          <div className="text-xl font-bold text-[var(--accent)]" style={{ fontFamily: "'DM Serif Display', serif" }}>600K+</div>
          <div className="text-xs text-[var(--text-muted)]">Free Tracks</div>
        </div>
        <div className="bg-[var(--surface)] p-4 text-center border-r border-[var(--border)]">
          <div className="text-xl font-bold text-[var(--accent)]" style={{ fontFamily: "'DM Serif Display', serif" }}>30K+</div>
          <div className="text-xs text-[var(--text-muted)]">Radio Stations</div>
        </div>
        <div className="bg-[var(--surface)] p-4 text-center">
          <div className="text-xl font-bold text-[var(--accent)]" style={{ fontFamily: "'DM Serif Display', serif" }}>$0</div>
      ...
      <div className="px-4 mb-8">
        ...
        <div className="grid gap-3">
          {[
            ...
            <div key={f.title} className="flex gap-3 bg-[var(--surface)] border border-[var(--border)] rounded-xl p-4">
      ...
      <div className="px-4 mb-8">
        ...
        <p className="text-sm text-[var(--text-muted)] mb-4">Every track is Creative Commons licensed or public domain. Completely legal.</p>
        <div className="grid gap-3">
          {[
            ...
            <div key={s.name} className="bg-[var(--surface)] border border-[var(--border)] rounded-xl p-4 text-center">
              <div className="text-lg font-bold text-[var(--accent)]" style={{ fontFamily: "'DM Serif Display', serif" }}>{s.count}</div>
          ...
          {[
            ...
            <div key={title} className="flex gap-2.5 items-start">
              <div className="w-5 h-5 rounded-full bg-[var(--accent)]/20 flex items-center justify-center flex-shrink-0 mt-0.5">
                <svg className="w-3 h-3 text-[var(--accent)]" fill="currentColor" viewBox="0 0 20 20"><path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd"/></svg>
              </div>
              <div className="text-sm text-[var(--text-muted)]"><strong className="text-[var(--text)]">{title}.</strong> {desc}</div>
            </div>
          ))}
        </div>
      </div>
      ...
      <div className="px-4 mb-8">
        <a
          ...
          className="flex items-center justify-center gap-2 w-full py-3 bg-[var(--surface)] border border-[var(--border)] rounded-xl text-sm font-semibold hover:border-[var(--accent)] transition-colors"
        >
      ...
      <div className="px-4 pb-4 text-center text-xs text-[var(--text-muted)]/50">
