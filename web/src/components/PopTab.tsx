...
import { ARTISTS, ERAS, SUBGENRES, type PopArtist } from '../services/pop'
...
function getItems(section: Section): PopArtist[] {
  switch (section) {
  ...
  return (
    <div className="pb-4">
      <div className="px-4 md:px-6 pt-6 md:pt-10 pb-1">
        <h1 className="text-2xl md:text-3xl font-bold font-display italic">Pop</h1>
        <p className="text-sm text-text-muted mt-1">Icons of popular music</p>
      </div>
